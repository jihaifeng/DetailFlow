package com.meechao.detailflow.richText;
...
public class TEditText extends AppCompatEditText {
  ...
  public TEditText(Context context, AttributeSet attrs) {
    ...
    textSizeTopic = t.getDimensionPixelOffset(R.styleable.TEditText_text_size_topic, ScreenUtil.dip2px(textSizeTopic));
  ...
  public TEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    LogUtils.i(TAG, "TEditText: ");
  }

  @Override public void setBackgroundResource(int resId) {
    super.setBackgroundResource(resId);
    LogUtils.i(TAG, "setBackgroundResource: ");
  }

  @Override public void setBackgroundDrawable(Drawable background) {
    super.setBackgroundDrawable(background);
    LogUtils.i(TAG, "setBackgroundDrawable: ");
  }

  @Override public void setSupportBackgroundTintList(@Nullable ColorStateList tint) {
    super.setSupportBackgroundTintList(tint);
    LogUtils.i(TAG, "setSupportBackgroundTintList: ");
  }

  @Nullable @Override public ColorStateList getSupportBackgroundTintList() {
    LogUtils.i(TAG, "getSupportBackgroundTintList: ");
    return super.getSupportBackgroundTintList();

  }

  @Override public void setSupportBackgroundTintMode(@Nullable PorterDuff.Mode tintMode) {
    LogUtils.i(TAG, "setSupportBackgroundTintMode: ");
    super.setSupportBackgroundTintMode(tintMode);

  }

  @Nullable @Override public PorterDuff.Mode getSupportBackgroundTintMode() {
    LogUtils.i(TAG, "getSupportBackgroundTintMode: ");
    return super.getSupportBackgroundTintMode();
  }

  @Override protected void drawableStateChanged() {
    super.drawableStateChanged();
    LogUtils.i(TAG, "drawableStateChanged: " +getDrawableState());

  }

  @Override public void setTextAppearance(Context context, int resId) {
    super.setTextAppearance(context, resId);
    LogUtils.i(TAG, "setTextAppearance: ");
  }

  @Override public boolean onFilterTouchEventForSecurity(MotionEvent event) {
    LogUtils.i(TAG, "onFilterTouchEventForSecurity: ");
  ...
  @Override public void setAutoSizeTextTypeWithDefaults(int autoSizeTextType) {
    super.setAutoSizeTextTypeWithDefaults(autoSizeTextType);
  }

  @Override public void setAutoSizeTextTypeUniformWithConfiguration(int autoSizeMinTextSize, int autoSizeMaxTextSize,
      int autoSizeStepGranularity, int unit) {
    super.setAutoSizeTextTypeUniformWithConfiguration(autoSizeMinTextSize, autoSizeMaxTextSize, autoSizeStepGranularity,
        unit);
  }

  @Override public void setAutoSizeTextTypeUniformWithPresetSizes(@NonNull int[] presetSizes, int unit) {
    super.setAutoSizeTextTypeUniformWithPresetSizes(presetSizes, unit);
  }

  @Override public int getAutoSizeTextType() {
    return super.getAutoSizeTextType();
  }

  @Override public int getAutoSizeStepGranularity() {
    return super.getAutoSizeStepGranularity();
  }

  @Override public int getAutoSizeMinTextSize() {
    return super.getAutoSizeMinTextSize();
  }

  @Override public int getAutoSizeMaxTextSize() {
    return super.getAutoSizeMaxTextSize();
  }

  @Override public int[] getAutoSizeTextAvailableSizes() {
  ...
  @Override public Editable getEditableText() {
  ...
  @Override public void setKeyListener(KeyListener input) {
  ...
  @Override public int getCompoundPaddingStart() {
    return super.getCompoundPaddingStart();
  }

  @Override public int getCompoundPaddingEnd() {
  ...
  @Override public int getTotalPaddingLeft() {
    return super.getTotalPaddingLeft();
  }

  @Override public int getTotalPaddingRight() {
    return super.getTotalPaddingRight();
  }

  @Override public int getTotalPaddingStart() {
    return super.getTotalPaddingStart();
  }

  @Override public int getTotalPaddingEnd() {
    return super.getTotalPaddingEnd();
  }

  @Override public int getTotalPaddingTop() {
    return super.getTotalPaddingTop();
  }

  @Override public int getTotalPaddingBottom() {
    return super.getTotalPaddingBottom();
  }

  @Override public void setCompoundDrawables(@Nullable Drawable left, @Nullable Drawable top, @Nullable Drawable right,
      @Nullable Drawable bottom) {
    super.setCompoundDrawables(left, top, right, bottom);
  }

  @Override public void setCompoundDrawablesWithIntrinsicBounds(int left, int top, int right, int bottom) {
    super.setCompoundDrawablesWithIntrinsicBounds(left, top, right, bottom);
  }

  @Override public void setCompoundDrawablesWithIntrinsicBounds(@Nullable Drawable left, @Nullable Drawable top,
      @Nullable Drawable right, @Nullable Drawable bottom) {
    super.setCompoundDrawablesWithIntrinsicBounds(left, top, right, bottom);
  }

  @Override
  public void setCompoundDrawablesRelative(@Nullable Drawable start, @Nullable Drawable top, @Nullable Drawable end,
      @Nullable Drawable bottom) {
    super.setCompoundDrawablesRelative(start, top, end, bottom);
  }

  @Override public void setCompoundDrawablesRelativeWithIntrinsicBounds(int start, int top, int end, int bottom) {
  ...
  @NonNull @Override public Drawable[] getCompoundDrawables() {
    return super.getCompoundDrawables();
  }

  @NonNull @Override public Drawable[] getCompoundDrawablesRelative() {
    return super.getCompoundDrawablesRelative();
  }

  @Override public void setCompoundDrawablePadding(int pad) {
    super.setCompoundDrawablePadding(pad);
  }

  @Override public int getCompoundDrawablePadding() {
  ...
  @Override public ColorStateList getCompoundDrawableTintList() {
    return super.getCompoundDrawableTintList();
  }

  @Override public void setCompoundDrawableTintMode(@Nullable PorterDuff.Mode tintMode) {
    super.setCompoundDrawableTintMode(tintMode);
  }

  @Override public PorterDuff.Mode getCompoundDrawableTintMode() {
  ...
  @Override public void setTextAppearance(int resId) {
    super.setTextAppearance(resId);
  }

  @NonNull @Override public Locale getTextLocale() {
    return super.getTextLocale();
  }

  @NonNull @Override public LocaleList getTextLocales() {
    return super.getTextLocales();
  }

  @Override public void setTextLocale(@NonNull Locale locale) {
    super.setTextLocale(locale);
  }

  @Override public void setTextLocales(@NonNull LocaleList locales) {
  ...
  @Override public float getTextScaleX() {
    return super.getTextScaleX();
  }

  @Override public void setTextScaleX(float size) {
  ...
  @Override public Typeface getTypeface() {
    return super.getTypeface();
  }

  @Override public void setElegantTextHeight(boolean elegant) {
  ...
  @Nullable @Override public String getFontFeatureSettings() {
    return super.getFontFeatureSettings();
  }

  @Nullable @Override public String getFontVariationSettings() {
    return super.getFontVariationSettings();
  }

  @Override public void setBreakStrategy(int breakStrategy) {
  ...
  @Override public void setHyphenationFrequency(int hyphenationFrequency) {
    super.setHyphenationFrequency(hyphenationFrequency);
  }

  @Override public int getHyphenationFrequency() {
    return super.getHyphenationFrequency();
  }

  @Override public void setJustificationMode(int justificationMode) {
    super.setJustificationMode(justificationMode);
  }

  @Override public int getJustificationMode() {
    return super.getJustificationMode();
  }

  @Override public void setFontFeatureSettings(@Nullable String fontFeatureSettings) {
    super.setFontFeatureSettings(fontFeatureSettings);
  }

  @Override public boolean setFontVariationSettings(@Nullable String fontVariationSettings) {
  ...
  @Override public void setHighlightColor(int color) {
  ...
  @Override public void setShadowLayer(float radius, float dx, float dy, int color) {
  ...
  @Override public float getShadowDx() {
    return super.getShadowDx();
  }

  @Override public float getShadowDy() {
  ...
  @Override public URLSpan[] getUrls() {
    return super.getUrls();
  }

  @Override public void setGravity(int gravity) {
  ...
  @Override public int getPaintFlags() {
    return super.getPaintFlags();
  }

  @Override public void setPaintFlags(int flags) {
    super.setPaintFlags(flags);
  }

  @Override public void setHorizontallyScrolling(boolean whether) {
    super.setHorizontallyScrolling(whether);
  }

  @Override public void setMinLines(int minLines) {
    super.setMinLines(minLines);
  }

  @Override public int getMinLines() {
    return super.getMinLines();
  }

  @Override public void setMinHeight(int minPixels) {
  ...
  @Override public void setMaxHeight(int maxPixels) {
  ...
  @Override public void setHeight(int pixels) {
    super.setHeight(pixels);
  }

  @Override public void setMinEms(int minEms) {
    super.setMinEms(minEms);
  }

  @Override public int getMinEms() {
    return super.getMinEms();
  }

  @Override public void setMinWidth(int minPixels) {
  ...
  @Override public void setMaxEms(int maxEms) {
    super.setMaxEms(maxEms);
  }

  @Override public int getMaxEms() {
    return super.getMaxEms();
  }

  @Override public void setMaxWidth(int maxPixels) {
  ...
  @Override public void setEms(int ems) {
    super.setEms(ems);
  }

  @Override public void setWidth(int pixels) {
  ...
  @Override public float getLineSpacingMultiplier() {
    return super.getLineSpacingMultiplier();
  }

  @Override public float getLineSpacingExtra() {
    return super.getLineSpacingExtra();
  }

  @Override public void append(CharSequence text, int start, int end) {
  ...
  @Override public void setFreezesText(boolean freezesText) {
    super.setFreezesText(freezesText);
  }

  @Override public CharSequence getHint() {
  ...
  @Override public void setRawInputType(int type) {
  ...
  @Override public void setImeOptions(int imeOptions) {
    super.setImeOptions(imeOptions);
  }

  @Override public int getImeOptions() {
    return super.getImeOptions();
  }

  @Override public void setImeActionLabel(CharSequence label, int actionId) {
    super.setImeActionLabel(label, actionId);
  }

  @Override public CharSequence getImeActionLabel() {
    return super.getImeActionLabel();
  }

  @Override public int getImeActionId() {
    return super.getImeActionId();
  }

  @Override public void setOnEditorActionListener(OnEditorActionListener l) {
  ...
  @Override public void setPrivateImeOptions(String type) {
    super.setPrivateImeOptions(type);
  }

  @Override public String getPrivateImeOptions() {
    return super.getPrivateImeOptions();
  }

  @Override public void setInputExtras(int xmlResId) throws XmlPullParserException, IOException {
    super.setInputExtras(xmlResId);
  }

  @Override public Bundle getInputExtras(boolean create) {
    return super.getInputExtras(create);
  }

  @Override public void setImeHintLocales(@Nullable LocaleList hintLocales) {
    super.setImeHintLocales(hintLocales);
  }

  @Nullable @Override public LocaleList getImeHintLocales() {
  ...
  @Override public boolean isTextSelectable() {
    return super.isTextSelectable();
  }

  @Override public void setTextIsSelectable(boolean selectable) {
  ...
  @Override public int getLineBounds(int line, Rect bounds) {
  ...
  @Override public boolean extractText(ExtractedTextRequest request, ExtractedText outText) {
  ...
  @Override public void onCommitCompletion(CompletionInfo text) {
    super.onCommitCompletion(text);
  }

  @Override public void onCommitCorrection(CorrectionInfo info) {
    super.onCommitCorrection(info);
  }

  @Override public void beginBatchEdit() {
    super.beginBatchEdit();
  }

  @Override public void endBatchEdit() {
    super.endBatchEdit();
  }

  @Override public void onBeginBatchEdit() {
    super.onBeginBatchEdit();
  }

  @Override public void onEndBatchEdit() {
    super.onEndBatchEdit();
  }

  @Override public boolean onPrivateIMECommand(String action, Bundle data) {
    return super.onPrivateIMECommand(action, data);
  }

  @Override public void setIncludeFontPadding(boolean includepad) {
    super.setIncludeFontPadding(includepad);
  }

  @Override public boolean getIncludeFontPadding() {
  ...
  @Override public boolean bringPointIntoView(int offset) {
    return super.bringPointIntoView(offset);
  }

  @Override public boolean moveCursorToVisibleOffset() {
  ...
  @Override public void debug(int depth) {
    super.debug(depth);
  }
  ...
  @Override public void setMarqueeRepeatLimit(int marqueeLimit) {
    super.setMarqueeRepeatLimit(marqueeLimit);
  }

  @Override public int getMarqueeRepeatLimit() {
    return super.getMarqueeRepeatLimit();
  }

  @Override public TextUtils.TruncateAt getEllipsize() {
    return super.getEllipsize();
  }

  @Override public void setSelectAllOnFocus(boolean selectAllOnFocus) {
  ...
  @Override public boolean isCursorVisible() {
  ...
  @Override public void clearComposingText() {
  ...
  @Override public boolean showContextMenu(float x, float y) {
    return super.showContextMenu(x, y);
  }

  @Override public boolean didTouchFocusSelect() {
  ...
  @Override public void setScroller(Scroller s) {
    super.setScroller(s);
  }
  ...
  @Override public void findViewsWithText(ArrayList<View> outViews, CharSequence searched, int flags) {
  ...
  @Override public void onProvideStructure(ViewStructure structure) {
  ...
  @Override public void autofill(AutofillValue value) {
    super.autofill(value);
  }

  @Override public int getAutofillType() {
    return super.getAutofillType();
  }

  @Nullable @Override public AutofillValue getAutofillValue() {
  ...
  @Override public boolean isInputMethodTarget() {
  ...
  @Override protected void onScrollChanged(int horiz, int vert, int oldHoriz, int oldVert) {
  ...
  @Override public ActionMode.Callback getCustomSelectionActionModeCallback() {
    return super.getCustomSelectionActionModeCallback();
  }

  @Override public void setCustomInsertionActionModeCallback(ActionMode.Callback actionModeCallback) {
    super.setCustomInsertionActionModeCallback(actionModeCallback);
  }

  @Override public ActionMode.Callback getCustomInsertionActionModeCallback() {
    return super.getCustomInsertionActionModeCallback();
  }

  @Override public void setTextClassifier(@Nullable TextClassifier textClassifier) {
    super.setTextClassifier(textClassifier);
  }

  @NonNull @Override public TextClassifier getTextClassifier() {
