package com.meechao.detailflow.wedget.flowView;
...
public class PageFlowView extends LinearLayout {
  ...
  private PageScrollView.TagStyle default_style;
  ...
  public PageFlowView(Context context, AttributeSet attrs) {
    ...
    try {
      indicatorMargin = a.getInt(R.styleable.PageFlowView_indicatorMargin, 10);
  ...
  private void init() {
    ...
    if (null == default_style) {
      int margin = ScreenUtil.dip2px(4);
      default_style = PageScrollView.TagStyle.build()
          .backgroundResId(R.drawable.selector_keyboard_topic)
          .textColor(getResources().getColor(R.color.color_7e828b))
          .textSize((int) ScreenUtil.sp2Px(14))
  ...
  public void setData(List<String> data) {
    if (scrollView != null) {
      scrollView.setData(data, default_style);
    }
  }

  public void setData(List<String> data, PageScrollView.TagStyle tagStyle) {
    if (scrollView != null) {
  ...
  public CheckedTextView addTag(int scrollTo, String text) {
    return addTag(scrollTo, text, default_style);
  }
